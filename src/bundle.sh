...
files=(src/AUTO/autoselect.py src/MAIN_GB/main1.py   src/DRIVER_FUNCTIONS/LB.py src/INIT/init.py src/PID_FORWARD/PID.py src/PID_FORWARD/NEWPID.py src/AUTO/autonomous.py src/DRIVER_FUNCTIONS/drive.py src/OTHER/testcode.py src/PID_TURN/PIDTURN.py)
total_files=${#files[@]}
counter=0
...
compile_count_file="$(dirname "$(realpath "$0")")/compile_count.txt"
